...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    express: {
      ...
      dev: {
        options: {
          script: 'server/coc.js',
          debug: true
        }
      },
      prod: {
        options: {
          script: 'dist/server/coc.js'
        }
      }
    },
    open: {
    ...
    shell: {
      publish: {
        ...
        command: 'rsync -avz --delete dist/* a.jmjeong.com:~/node/coc2'
      }
    },
